...
public class EmprestimoDAO {
    ...
    public static void listarRelatorioEmprestimos() throws SQLException {
    	String sql = """
    		    SELECT l.id_livro, l.titulo, e.data_emprestimo, e.data_devolucao
    		    FROM Emprestimos e
        ...
        try (Connection conn = DB.getConnection();
            ...
            if (!encontrou) {
                System.out.println("Nenhum relatório de empréstimo encontrado.");
            }
        }
    }
}
